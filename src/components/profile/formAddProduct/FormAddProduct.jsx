...
const UpdateOpenMarket = ({ id, showFormAddProduct, setShowFormAddProduct}) => {
    ...
    async function addProducte(e) {
        ...
        await axios.post(`${process.env.REACT_APP_API_URI}api/shop/create_product`, formData,
        {
            headers : {
  ...
  return (
    <>
    {
        ...
        <div className={styles.form_add_product}>
            <div onClick={() => setShowFormAddProduct(false)} className={styles.backdrop}></div>
            <div className={`${styles.add_product_container} container`}>
            <div className={styles.x_btn} onClick={() => setShowFormAddProduct(!showFormAddProduct)} >X</div>
