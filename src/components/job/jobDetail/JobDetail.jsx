...
import { faCity, faClock, faEarth, faLocation, faPhone, faRibbon, faUserGroup } from '@fortawesome/free-solid-svg-icons'
    ...
    <div>
        {
            ...
            <div className={styles.job_details_card}>
                <div className={styles.job_details_title}>
                  <img className={styles.job_details_logo} src="/assets/find-me-logo.png" alt=''></img>
                    <p>4 Days Ago</p>
                </div>
