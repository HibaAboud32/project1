...
import styles from "./searchCompanyInput.module.css";
import { faMagnifyingGlass } from "@fortawesome/free-solid-svg-icons";
import { FontAwesomeIcon } from "@fortawesome/react-fontawesome";
import axios from "axios";
import { useLocation, useNavigate, useSearchParams } from "react-router-dom";

const SearchCompanyInput = ({ setResault, urlSearch }) => {
  ...
  const handleSearch = () => {
    ...
    params.append("category", categorySelected);
    params.append("search", search);
    navigate(`/searchcompany?${params.toString()}`);
  };
          ...
          <div className={styles.search_contetn}>
            ...
            >
              ...
              )}
              {
                ...
                // <div className={styles.filter_select}>
                //   <div className={styles.filter_section}>
                //     <select onChange={(e) => setCategorySelected(e.target.value)} name="Category" id="">
                //       {
                //         jobCtegory.map((element, index) => (
                ...
                //   </div>
                // </div>
                location.pathname === "/job" || "/job/jobdetails" ? (
                  <div className={styles.filter_select}>
                    <div className={styles.filter_section}>
                      <select
                        onChange={(e) => setCategorySelected(e.target.value)}
